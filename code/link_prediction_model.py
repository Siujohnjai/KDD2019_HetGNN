...
def model(train_num, test_num):
	...
	train_data_f = "train_feature.txt"
	train_data = load_data(args.data_path + train_data_f, args.embed_d + 3, train_num)
	...
	test_data_f = "test_feature.txt"
	test_data = load_data(args.data_path + test_data_f, args.embed_d + 3, test_num)
	...
	output_f = open("link_prediction.txt", "w")
